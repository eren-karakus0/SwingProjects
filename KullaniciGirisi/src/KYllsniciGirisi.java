 ...
 * @author EREN
 */
public class KYllsniciGirisi extends javax.swing.JFrame {

    /**
     * Creates new form KYllsniciGirisi
     */
    public KYllsniciGirisi() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(kullaniciAdi.equals("Eren")&& parola.equals("123456"))
        {
            message = "Welcome!" + kullaniciAdi;
        }
        else if(!kullaniciAdi.equals("Eren")&& parola.equals("123456"))
        {
        ...
        if(message.equals("Welcome!" + kullaniciAdi))
        {
            ...
            //setVisible(false);//pencereyi kapatıyor (Program hala açık)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KYllsniciGirisi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KYllsniciGirisi().setVisible(true);
            }
        });
    }
